            ...
            <nav class="bg-white border-b border-slate-100 shadow">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden sm:items-center space-x-6 sm:-my-px sm:ml-10 sm:flex" v-if="$page.props.auth.user.roles[0]">
                                ...
                                <NavLink :href="route('proposal.index')" :active="route().current('proposal.index')" class="pb-2 sm:hidden md:flex" v-if="$page.props.auth.user.roles[0].id != 3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                                ...
                                <NavLink :href="route('reports')" :active="route().current('reports')" class="pb-2 sm:hidden md:flex" v-if="$page.props.auth.user.roles[0].id === 1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-1">
                        ...
                        <div class="md:flex sm:hidden sm:items-center sm:ml-6" v-if="$page.props.auth.user.roles[0]">
                            ...
                            <div v-if="$page.props.auth.user.roles[0].id === 1" class="sm:hidden md:flex">
                                <select
                                    v-model="company"
                                    name="product"
                ...
                >   
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('proposal.index')" :active="route().current('proposal.index')" v-if="$page.props.auth.user.roles[0].id != 3">
                            Proposta Comercial
                        </ResponsiveNavLink>
                    ...
                    <div class="pt-4 pb-1 border-t border-slate-200">
                        ...
                        <div v-if="$page.props.auth.user.roles[0].id === 1" class="sm:flex md:hidden pb-4">
                            <select
                                v-model="company"
                                name="product"
