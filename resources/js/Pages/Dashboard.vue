            ...
            <div class="py-1">
                <div class="max-w-7xl mx-auto sm:px-4 mt-4 space-y-6 md:px-10">
                    <div class="flex justify-end">
                        ...
                        <div class="flex" v-if="props.role === 1 || props.role === 4">
                            <Button 
                                variant="default" 
                                type="button" 
                                class="ml-2 py-2.5"
                    ...
                    <div v-if="props.role === 1 || props.role === 4" class="grid sm:grid-cols-1 md:grid-cols-1 gap-4">
                        <div class="bg-white shadow-sm border border-slate-200 px-6 py-3">
                    ...
                    <div v-if="props.role === 1" class="grid sm:grid-cols-1 md:grid-cols-1 gap-4">
                        <div class="bg-white shadow-sm border border-slate-200 px-6 py-3">
                        ...
                        <form @submit.prevent="filterLeads">
                            <div class="p-5 py-5 space-y-5">
                                <div class="grid grid-cols-1 gap-4">
                                    <div  v-if="props.role === 1 " class="col-span-3">
