...
<template>
    ...
    <AuthenticatedLayout>
                            ...
                            <li
                                ...
                                <div class="justify-between md:flex mt-4">                                
                                    ...
                                    <div class="flex text-slate-400 space-x-2 md:pt-2 sm:pt-1 justify-between">
                                        ...
                                        <span v-if="props.role === 1 || props.role === 4" class=" pt-0.5 text-xxs cursor-default" title="Usuário Responsável">{{ lead.usuario}}</span>
                            ...
                            <li 
                                ...
                                <div class="justify-between md:flex mt-4">   
                                    ...
                                    <div class="flex text-slate-400 space-x-2 md:pt-2 sm:pt-1 justify-between">
                                        ...
                                        <span v-if="props.role === 1 || props.role === 4" class="pt-0.5 text-slate-400 text-xxs cursor-default">{{ lead.usuario}}</span>
                                    </div>
                                </div>
                            </li>
                        </ul>
                        ...
                        <ul class="pt-2">
                            <li 
                                ...
                                <div class="justify-between md:flex mt-4">                                
                                    ...
                                    <div class="flex text-slate-400 space-x-2 md:pt-2 sm:pt-1 justify-between">
                                        <span class="text-slate-400 text-xxs pt-0.5"> Recebido em {{ moment(lead.created_at).format("DD/MM/YYYY HH:mm") }}</span> 
                                        <span v-if="props.role === 1 || props.role === 4" class="text-xxs pt-0.5">{{ lead.usuario}}</span>
                                    </div>                              
                                </div>
        ...
        <Forward :show="forwardShow" page="/lead" :companies="companies" :status="status" :users="users" @closeSlide="closeSlide()" @closeProposal="closeSlide()" ></Forward>
